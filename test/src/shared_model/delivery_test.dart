...
void main() {
  group('Delivery', () {
    test('converts from Json', () {
      expect(
        Delivery.fromJson(DeliveryResponseTestData.successJson),
        isA<Delivery>(),
      );
    });
  });
...
abstract class DeliveryResponseTestData {
  static const successJson = {
    ...
    'dropoff_location': {'lat': 123.1312343, 'lng': -37.2144343},
    ...
    'items': [
      {
        ...
        'barcode': '12342830041',
        'item_options': {
          'substitute_item_ids': ['123443434', '123443435'],
          'weight_unit': 'oz',
    ...
    'shopping_options': {
      ...
      'payment_gift_cards': ['123443434', '123443435'],
...
''',
    ...
    'dasher_location': {'lat': 123.1312343, 'lng': -37.2144343},
